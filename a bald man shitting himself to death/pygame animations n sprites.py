...
pygame.display.set_caption("Bald man jumping simulator(with a gun)")
...
while run:
    ...
    if keys[pygame.K_SPACE]:
        if man.left:
            ...
            facing = 1
        if len(bullets) < 500:
            bullets.append(projectile(round(man.x + man.width //2), round(man.y + man.height//2), 6, (119,57,23), facing))
